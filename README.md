...
The API documentation is generated by Doxygen and published to
**[rdoxalis.github.io/lobshooter](https://rdoxalis.github.io/lobshooter/)** on
every push. Build it locally with `doxygen Doxyfile`, which writes into `html/`
— that directory is generated and not kept in the repository.

This README doubles as the documentation's start page, so usage changes belong
here rather than in the sources.
